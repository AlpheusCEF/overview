...
> **Status**: Complete. `AlpheusCEF/homebrew-tap` ships `brew install alph` (v0.1.23). Release workflow auto-builds sdist; formula updated manually until `HOMEBREW_TAP_TOKEN` is configured.
