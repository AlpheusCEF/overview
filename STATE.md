...
Phase 1, Phase 2, and remote registry support are complete. The project is at v0.1.28 (Homebrew). Tab completion and remote pool completion with caching implemented (v0.1.29, not yet released to Homebrew).
