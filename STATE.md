...
Phase 1, Phase 2, and remote registry support are complete. The project is at v0.1.29 (Homebrew). `alph completions show/install` commands replace the broken Typer built-in (v0.1.30, not yet released to Homebrew).
